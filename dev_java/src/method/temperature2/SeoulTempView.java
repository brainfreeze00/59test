...
public class SeoulTempView implements ActionListener, FocusListener { //implements : ? // 자바는 다중상속은 불가하다  그 불편함을 해소하기위해 다중 인터페이스를 
    //선언부
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj == jtf_date) {
            ...
            jp_north.remove(jcb_mm); //새로 입력하기위해 기존 삭제
            jcb_mm =null; // 새로 초기화
            jcb_mm = new JComboBox(months); //새로 인스턴스화
            jcb_mm.addActionListener(this);//주소번지 달라짐  고로 다시 ddActionListener(this)입력
