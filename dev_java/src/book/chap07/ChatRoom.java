...
public class ChatRoom extends JFrame{
	...
	//데이터는 존재하지 않으므로 0을 주었고 컬럼의 수는 톡방명, 총인원수, 현재 참여자명단
	//이렇게 3이므로 3을 주었음
	String data[][] = new String[0][3];
	//실제로 데이터를 담을수 있는 자바에서 제공되는 클래스임
	//화면에 붙일때는 헤더정보들은 2차배열에 포함시키지않음
	...
	public ChatRoom() {
		...
		//따라서 최종적으로 화면에 붙일 떄 JTable이 아닌 JScrollPane이 붙음.
